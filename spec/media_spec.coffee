...
{selectMedia, getOriginal} = mediaHelper = require '../client/js/views/helpers/media_helper.coffee'
...
describe 'Media helpers', ->
  ...
  describe 'getOriginal', ->
    it 'should return the original', ->
      getOriginal(pictureWithTooLargeMedia).src.should.equal 'http://example.com/2048x1536.jpg'

    it 'should return undefined when there is no original', ->
      should.not.exist getOriginal(picture)